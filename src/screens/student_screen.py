...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input('Enter your name', placeholder='E.g. Tony Stark')
            ...
            try:
                audio_data = st.audio_input("Record a short phrase like I am present, My name is Tony Stark.")
                ...
                if new_name:
                    with st.spinner('Creating profile..'):
                        ...
                        if encodings:
                            ...
                            st.error("Couldn't detect face in the image, please try again!")
